...
output = File.new('OUTPUT.txt', 'w') # 'a+' will not erase previous runs
#########################################################
output.puts "*********************************************************************"
...
search_result_page_el = "//*[@id='fs_content_toolbox']/div[4]/div[1]/span"
search_result_number = "//*[@id='sectioncount']/span[1]"
search_res_origin_airport = 'inlineorigin'
search_res_destination_airport = 'inlinedestination'
search_res_departure_date = "//*[@id='travel_dates-start-display']"
search_res_return_date = "//*[@id='travel_dates-end-display']"
...
input.each do |line|
  ...
  begin
    ...
    output.puts "***PASSED*** Depart Date: #{browser.find_element(:xpath,search_res_departure_date).text}/2014"
    # Return Date
    sleep(1)
    browser.find_element(:xpath => end_date).click
    sleep(1)
    browser.find_element(:xpath => return_date).click
    output.puts "***PASSED*** Return Date: #{browser.find_element(:xpath,search_res_return_date).text}/2014"
    # Find Flights Button
    ...
    # Assertion of the Origin Details
    from = browser.find_element(:id, search_res_origin_airport).attribute('value')
